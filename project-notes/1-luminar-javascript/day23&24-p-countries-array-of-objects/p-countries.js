// install thunder client in vscode
//click on thunder client icon on left tray
// paste https://restcountries.com/v2/all and click send
// copy the code and past it here as a variable named countries
// the pasted data is an array of objects, where each object has data of a country

// q1) display the following datas from countries: all country name, capital, population, currency name. The output must of the form of array of object where object is of the form [ { countryName: xxx, capital:xxx, population:xxx, currency}]
var countries = [
    {
      "name": "Afghanistan",
      "topLevelDomain": [
...
for (let items of countries) {
   var country_name = items.name
   var capital = items.capital
   var population = items.population
  // let currency = items.currencies[0].name
  // console.log(currency) // won't print properly because the eight country has no currencies property
   var currency
  if ("currencies" in items){
    currency = items.currencies[0].name
  }
  else {
    currency = "no currency"
  }
  array_objects = { country_name, capital, population, currency }
  output_array.push(array_objects)
} 
...
console.log("****displaying only country names****")
output_array.map( e => e.country_name).forEach( n => console.log(n)) 
//or
output_array.forEach( n => console.log(n.country_name))

// q3) display only data of India
console.log("****details of India****")
let india_data = output_array.find( e => e.country_name == "India")
console.log(india_data)

// q4) display only the currency of China
console.log("****currency of China is****")
let china_currency = output_array.find( e => e.country_name == "China").currency //no need to map use .currency
console.log(china_currency)
// q5) print all countries with population above 2 crore.
console.log("****countries population above 2 crore****")

output_array.filter( n => n.population > 20000000).forEach( e => console.log(e.country_name))
